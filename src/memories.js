...
class Memories {
  ...
  getMemoTime() {
    if (
      this.endCalDate.toString().match(this.startCalDate) &&
      this.endCalTime.toString().match(this.startCalTime)
    ) {
      return "baru saja";
    } else {
  ...
  getAccordingMonth() {
    switch (parseInt(this.endCalDate[0])) {
      case 1:
        return this.getMonthMemo(31);
      case 2:
        return this.getMonthMemo(29);
      case 3:
        return this.getMonthMemo(31);
      case 4:
        return this.getMonthMemo(30);
      case 5:
        return this.getMonthMemo(31);
      case 6:
        return this.getMonthMemo(30);
    ...
    if (onMonth) {
      if (onDay) {
        ...
        // minutes
          ...
          this.currentTime =
            current < minutes && parseInt(current) + " menit yang lalu";
        }
        // minutes or hour
        else if (parseInt(h) != parseInt(H)) {
          current =
            parseInt(i) >= parseInt(I) && parseInt(i) - parseInt(I) + minutes;
        ...
        let day =
            this.day +
            parseInt(this.endCalDate[1]) -
            (this.day + parseInt(this.startCalDate[1])),
          currentMinutes;
        ...
        if (day == 1) {
          if (parseInt(h) > parseInt(H)) {
            ...
            if (current > hour) {
              this.currentTime =
                parseInt(this.endCalDate[1]) > this.startCalDate[1] &&
                parseInt(this.endCalDate[1]) -
                  this.startCalDate[1] +
                  " hari yang lalu";
            }
            ...
            if (current == hour && currentMinutes > minutes) {
              this.currentTime =
                Math.floor(hour % current) + 1 + " hari yang lalu";
            } else {
